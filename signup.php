...
<body>
  <div class="upper-container">
    ...
    <div class="container">
      ...
      <button id="btn-signup" class="btn btn-outline-success w-100">Sign Up</button>

      <div class="container" style="background-color:#f1f1f1; text-align: center;">
        <span>You already have an account ? <a class="btn btn-outline-primary" href="login.php">Login</a></span>
      </div>
    </div>
  </div>
